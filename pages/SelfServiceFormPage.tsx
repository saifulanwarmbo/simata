...
const SelfServiceFormPage: React.FC<SelfServiceFormPageProps> = ({ onSave }) => {
    ...
    }, [formData.performance, formData.potential, formData.nip, formData.eselon, formData.pendidikan]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newEmployeeData: Omit<Employee, 'id' | 'avatar' | 'submissionType' | 'status'> = {
            ...formData,
            unitKerja: formData.unitKerja === 'Lainnya' ? (formData as any).unitKerjaLainnya || '' : formData.unitKerja,
