...
const Header: React.FC<HeaderProps> = ({ title, subtitle, showControls, onAddEmployee, onSearchChange, sortKey, onSortKeyChange, successionStatusFilter, onSuccessionStatusFilterChange, onImportData, onDownloadTemplate }) => {
    return (
        <header>
